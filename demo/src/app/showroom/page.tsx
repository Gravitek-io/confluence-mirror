    ...
    content: [
      {
        ...
        attrs: { level: 1 },
        content: [
          { type: 'text', text: '🎨 Confluence to React - Showroom' }
        ]
      },
      {
        type: 'paragraph',
        content: [
          { type: 'text', text: 'This page showcases all the Confluence elements supported by our application.' }
        ]
      },
      {
        type: 'extension',
      ...
      },
      {
        ...
        content: [
          { type: 'text', text: 'Here is a ' },
          {
            ...
            marks: [{
              type: 'link',
              attrs: { href: 'https://www.atlassian.com/software/confluence' }
            }]
          },
          { type: 'text', text: '.' }
        ]
      ...
      },
      {
        ...
        attrs: { level: 2 },
        content: [
          { type: 'text', text: 'Special Confluence Elements' }
        ]
      },
      {
        type: 'paragraph',
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'mention', attrs: { text: 'John Doe', displayName: 'John Doe' } }
        ]
      },
      {
        type: 'paragraph',
        ...
        content: [
          {
            type: 'paragraph',
            content: [
              { type: 'text', text: 'This is an information panel with an icon.' }
            ]
          }
        ]
      },
        ...
        content: [
          {
            type: 'paragraph',
            content: [
              { type: 'text', text: 'This is a warning panel.' }
            ]
          }
        ]
      },
        ...
        content: [
          {
            type: 'paragraph',
            content: [
              { type: 'text', text: 'This is an error panel.' }
            ]
          }
        ]
      },
      ...
      },
      {
        ...
        attrs: { level: 2 },
        content: [
          { type: 'text', text: 'Quotes and Code' }
        ]
      },
      {
        type: 'blockquote',
        content: [
          {
            type: 'paragraph',
            content: [
              { type: 'text', text: 'This is a block quote. It can contain multiple lines and is styled with a left border.' }
            ]
          }
        ]
      },
            ...
            content: [
              ...
              },
              {
                ...
                content: [
                  {
                    type: 'paragraph',
                    content: [{ type: 'status', attrs: { text: 'Complete', color: 'green' } }]
                  }
                ]
              },
              {
                ...
                content: [
                  {
                    type: 'paragraph',
                    content: [{ type: 'text', text: 'Bold, italic, underline, code, links' }]
                  }
                ]
              }
            ]
            ...
            content: [
              ...
              },
              {
                ...
                content: [
                  {
                    type: 'paragraph',
                    content: [{ type: 'status', attrs: { text: 'Hybrid', color: 'blue' } }]
                  }
                ]
              },
              {
                ...
                content: [
                  {
                    type: 'paragraph',
                    content: [{ type: 'text', text: 'Via ADF + Storage mapping' }]
                  }
                ]
              }
            ]
      ...
      },
      {
        ...
        attrs: { level: 2 },
        content: [
          { type: 'text', text: 'Cards and Links' }
        ]
      },
      {
        type: 'paragraph',
      ...
      },
      {
        ...
        attrs: { level: 2 },
        content: [
          { type: 'text', text: 'Images and Media' }
        ]
      },
      {
        type: 'paragraph',
        content: [
          { type: 'text', text: 'Confluence images are supported via our hybrid approach that combines ADF and Storage for optimal rendering.' }
        ]
      },
      {
        type: 'mediaSingle',
      ...
      },
      {
        type: 'caption',
        content: [
          { type: 'text', text: 'Centered italic image caption' }
        ]
      },
      {
        type: 'heading',
        attrs: { level: 2 },
        content: [
          { type: 'text', text: 'Confluence Extensions' }
        ]
      },
      {
        type: 'extension',
        ...
        content: [
          {
            type: 'paragraph',
            content: [
              { type: 'text', text: 'Content of a custom Confluence extension.' }
            ]
          }
        ]
      },
          ...
          <div className="bg-white rounded-lg shadow-lg border border-gray-200">
            <div className="px-6 py-4 border-b border-gray-200">
              <div className="flex justify-between items-start">
                <div>
                  <h1 className="text-2xl font-bold text-gray-900 mb-2">Showroom - Supported ADF Types</h1>
                  <div className="flex items-center gap-4 text-sm text-gray-500">
                    <span>Demo Page</span>
                    <span>Confluence to React</span>
                  </div>
                </div>
